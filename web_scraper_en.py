...
def manipulate_page(driver:object, base_uri:str)->None:
    """"""
    ...
    ### Manipulating page elements to download EVM files for the 2nd round
...
def select_evm(driver:object)->int:
    """"""
    ...
    def find_list_element(name:str)->object:
        ...
        while element is None:
            ...
            try:
                ...
                error(f'Element {name} not found! Trying again in half second.')
                time.sleep(.5)
            else:
                return element
    ...
    def get_list_of_options(type_of_options:str)->list:
        ...
        while options is None:
            ...
            try:
                ...
                error(f'List of {type_of_options} not found! Trying again in half second.')
                time.sleep(.5)
            else:
                return options
    ...
    municipalities = get_list_of_options('municipalities')
    ...
    for i_m, municipality in enumerate(municipalities):
        ...
        zones = get_list_of_options('zones')
        ...
        for i_z, zone in enumerate(zones):
            ...
            sections = get_list_of_options('sections')
...
def start()->None:
    ...
    manipulate_page(driver, base_uri)

    time.sleep(2)

    downloaded_total = select_evm(driver)
